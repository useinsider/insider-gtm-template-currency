...

{
  ...
  "version": 1,
  "securityGroups": [],
  "displayName": "Insider Payment Currency",
  ...
  "description": "This template defines currency.",
  "containerContexts": [
    "WEB"
  ]
}
...
[
  {
    ...
    "defaultValue": "pageInfo.currency"
  }
]
...
insiderObject.basket.currency = getData(data.currency);
...
Created on 11/20/2020, 3:02:29 PM
